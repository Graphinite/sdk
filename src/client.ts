...
export class GraphiniteClient {

  /** url where _every_ request will be sent */
  private url: string;

  /**
   * Create a new instance of a client to interact with the Graphinite REST API.
   ...
   */
  constructor(private token: string, public options?: GraphiniteClientOptions) {
